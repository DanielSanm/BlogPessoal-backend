package com.generation.blogPessoalOficial.security;
...
//	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
//		auth.userDetailsService(userDetailsService);
//		auth.inMemoryAuthentication().withUser("root").password(passowordEncoder().encode("root")).authorities("ROLE_USER");
//	}
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(userDetailsService);
		auth.inMemoryAuthentication().withUser("root").password(passowordEncoder().encode("root"))
