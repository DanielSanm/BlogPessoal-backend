package com.generation.blogPessoalOficial.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.generation.blogPessoalOficial.controllers"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/DanielSanm")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Daniel Elias", "https://github.com/DanielSanm", "danielelias3221@gmail.com");
	}
